    ...
    <motion.div initial={{opacity: 0, x:200}} transition={{duration: 1}} whileInView={{opacity: 1, x:0}} viewport={{once: true}} className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
            ...
            <p className='my-10 max-w-lg'>At Estate, we specialize in offering premium
            properties that blend luxury with comfort. With
            years of expertise in real estate, our team
            provides personalized services to meet your unique
            needs and aspirations, ensuring seamless transactions.</p>
